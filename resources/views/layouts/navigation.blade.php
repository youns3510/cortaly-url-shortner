                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('article.index')" :active="request()->routeIs('article.index')">
                                    {{ __('All Articles') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('article.trashed')" :active="request()->routeIs('article.trashed')">
                                    {{ __('Trashed Articles') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('article.create')" :active="request()->routeIs('article.create')">
                                    {{ __('Create Article') }}
                                </x-dropdown-link>
