      ...
      <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
       <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
        <div class="overflow-hidden">
            ...
            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
             ...
             <div class="flex items-center justify-center mb-3">
              <div class="inline-flex shadow-md hover:shadow-lg focus:shadow-lg" role="group">
               ...
               <x-link title="Show" target="_blank" :href="route('short.show', $short_link->token)"
               ...
               <x-link title="Edit" :href="route('short.edit', $short_link->id)"
               ...
               <x-link x-data="{}" @click.prevent="$refs.destroy_short_link.submit()" title="Delete"
                ...
                <form x-ref="destroy_short_link" action="{{route('short.destroy', $short_link->id)}}"
                 method="POST">
                 @csrf
                 @method('DELETE')
                </form>
         ...
         @else
         <h3 class="text-center font-bold ">No Short links Here</h3>
         @endunless
        </div>
       </div>
      </div>
